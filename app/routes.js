...
require('./routes/task--reassign')(router)
...
require('./routes/case--outline')(router)
...
require('./routes/case--redact-material')(router)
...
require('./routes/case--charges-add')(router)
require('./routes/case--charges-discontinue')(router)
require('./routes/case--charges-propose-discontinuance')(router)
require('./routes/case--charges-revoke-proposal')(router)
